...
func _ready():
	if Global.ending == 0:
		$MarginContainer/Label.text = "[center]You retired on Elysium station. 
		You will enjoy a life of luxury while looking down at your former comrade in the lower class."
	elif Global.ending == 1:
		$MarginContainer/Label.text = "[center]Elysium, the ivory throne of the ruling capitalists, was destroyed and not entirely undue to your efforts.
